...
public class LessonDaoImpl implements LessonDao {
    ...
    public List<Lesson> getTodayLessonsByTrainer(int trainerId) {
        ...
        String SQL = "select l.id, l.is_cancel, l.lesson_date, l.time_slot_id, l.course_id from \"Lesson\" l join \"Course\" c on l.course_id = c.id where c.user_id = ? and cast(l.start_date_time as date) = cast(current_timestamp as date)";
